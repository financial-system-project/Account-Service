            ...
            steps {
                ...
                withCredentials([string(
                    ...
                    sh """
                        ...
                        cd GitOps/charts/account


                        sed -i '' '/repository: mahendra3\\/account/{n;s/tag:.*/tag: "'${BUILD_NUMBER}'"/;}' values.yaml
                        ...
                        git commit -m "Updated image tag to ${BUILD_NUMBER} in Account service"
            ...
            steps {
                withCredentials([usernamePassword(
                    ...
                    sh '''
                        ...
                        ansible-playbook Deployment/deploy.yaml -i Deployment/inventory.ini -e "argocd_app_name=account-app"
